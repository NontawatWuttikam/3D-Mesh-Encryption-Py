...
secp112r1 = ShortWeierstrassCurve(
    ...
    G_x=0x9487239995a5ee76b55f9c2f098,
...
sect113r1 = ShortWeierstrassCurve(
    name="sect113r1",
    a=0x3088250ca6e7c7fe649ce85820f7,
    b=0xe8bee4d3e2260744188be0e9c723,
    p=0x20000000000000000000000000201,
    n=0x100000000000000d9ccec8a39e56f,
    G_x=0x9d73616f35f4ab1407d73562c10f,
    G_y=0xa52830277958ee84d1315ed31886
)
...
miniCurve = ShortWeierstrassCurve(
    name="miniCurve",
    a=1,
    b=18,
    p=23,
